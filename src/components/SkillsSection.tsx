...
export const SkillsSection: React.FC<SkillsSectionProps> = ({ categories }) => {
  return (
    <section id="keahlian" className="py-12 border-b border-neutral-200 dark:border-neutral-800">
      {/* Header Bagian */}
      <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {categories.map((cat, idx) => (
          <div
            key={idx}
            className="p-5 rounded-2xl bg-white dark:bg-neutral-900/80 border border-neutral-200/80 dark:border-neutral-800/80 hover:border-indigo-500/30 dark:hover:border-indigo-400/30 shadow-xs hover:shadow-md transition-all duration-300"
          >
